...
import { acknowledge, create, get, getAnalysis, list, reopen, requestAnalysis, resolve, update } from './controller.js';
...
incidentsRouter.get('/:incidentId/analysis', getAnalysis);
incidentsRouter.post('/:incidentId/analysis', requireRole('admin'), requestAnalysis);
